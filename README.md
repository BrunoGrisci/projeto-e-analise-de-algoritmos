...
| --- | --- | --- | --- | --- |
| Cashier's Algorithm | [`--- | JavaScript | Bruno Iochins Grisci | Jogo educacional web para praticar e ensinar o problema de troco por meio de cenários interativos. [https://github.com/BrunoGrisci/cashiers_algorithm_game/tree/main?tab=readme-ov-file](https://github.com/BrunoGrisci/cashiers_algorithm_game/tree/main?tab=readme-ov-file)|
